(function ($) {
    ...
    $.fn.responsiveMonthRange.defaults = {
        ...
        button: {
            previousYear: {show: false, label:"Previous Year"},
            ytd: {show: false, label:"Year To Date"},
            previousFY: {show: false, label:"Previous FY"},
            fiscalYtd: {show: false, label:"Fiscal YTD"},
